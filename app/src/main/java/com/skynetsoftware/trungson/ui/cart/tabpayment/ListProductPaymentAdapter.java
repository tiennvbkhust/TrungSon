...
public class ListProductPaymentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private final List<Product> models;
    Context context;

    public ListProductPaymentAdapter(Context context, List<Product> models) {
        this.models = models;
