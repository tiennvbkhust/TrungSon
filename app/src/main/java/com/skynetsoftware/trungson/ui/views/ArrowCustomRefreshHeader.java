...
public class ArrowCustomRefreshHeader extends LinearLayout implements BaseCustomRefreshHeader {
    ...
    public ArrowCustomRefreshHeader(Context context) {
        super(context);
        initView();
    }
     ...
     * @param attrs
     */
    public ArrowCustomRefreshHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
