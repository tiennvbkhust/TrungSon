...
public class ListProductsFragment extends BaseFragment implements ListProductsContract.View {
...
//        pagerProduct.setOffscreenPageLimit(0);
    ...
    public void onSuccessGetListCategories(List<Category> list) {
        ...
        adapterFilter = new FilterAdapter(this.lisCategories, getContext());
