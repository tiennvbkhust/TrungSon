...
public abstract class HintShapeView extends LinearLayout implements HintView {
    ...
    public HintShapeView(Context context){
        super(context);
    }

    public HintShapeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
